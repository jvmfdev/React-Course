...
/* Fisrt new class component*/

class Directory extends Component { 
    /* a constructor is required sometimes for a class component*/
    constructor(props){ /* props is short for properties*/
        super(props);
        this.state= { /* this is an special property in react that always holds an object*/
            campsites: [
                {
                    id: 0,
